...
How to run:
  ...
  2) From repo root:
       python marin/run/ray_run.py -- \\
         python -m experiments.speedrun.test-experiment-submission-14.main
...
SUBMISSION_BRANCH = "calvin-xu/test-experiment-submission-14-20"
...
AUTHOR = Author(
    ...
    url=(None if SUBMISSION_AUTHOR_URL in ("", "pinlinxu.com") else SUBMISSION_AUTHOR_URL),
)
