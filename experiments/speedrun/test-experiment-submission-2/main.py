...
How to run:
  ...
  2) From repo root:
       python marin/run/ray_run.py -- \\
         python -m experiments.speedrun.test-experiment-submission-2.main
...
SUBMISSION_BRANCH = "calvin-xu/test-experiment-submission-2"
SUBMISSION_DESCRIPTION = "Test Submission 2 Description"
SUBMISSION_AUTHOR_NAME = "Calvin Xu"
SUBMISSION_AUTHOR_AFFILIATION = "Stanford University"
SUBMISSION_AUTHOR_URL = "pinlinxu@stanford.edu"
...
AUTHOR = Author(
    ...
    url=(None if SUBMISSION_AUTHOR_URL in ("", "pinlinxu@stanford.edu") else SUBMISSION_AUTHOR_URL),
)
